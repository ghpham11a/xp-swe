...
def reverse_list(head):
    ...
    while curr_node:
        ...
        # Reverse the curr_nodeent node's pointer.
...
expected_list = ListNode(5, ListNode(4, ListNode(3, ListNode(2, ListNode(1)))))


assert(reverse_list(test_list) == expected_list)
